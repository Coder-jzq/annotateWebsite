...
@TableName("bz_record_pause")
@ApiModel(value="BzRecordPause对象", description="")
public class BzRecordPause implements Serializable {
    ...
    public BzRecordPause(){
        this.recordIndex = "";
        this.recordText = "";
    }

    public BzRecordPause(String recordIndex, String recordText,
